...
import { CuImageViewer, CuButton } from '@centui/react'
import DemoCanvasReact from '../../DemoCanvasReact'

const scenes = ['图片查看']
const code = `<CuImageViewer value={show} onChange={setShow} list={imgs} initialIndex={0} />`
const imgs = [
    ...
    <DemoCanvasReact mode="stage" scenes={scenes} code={code}>
      {() => (
        <div className="viewer-demo">
          ...
          <CuImageViewer value={show} list={imgs} initialIndex={0} />
        </div>
      )}
    </DemoCanvasReact>
  )
